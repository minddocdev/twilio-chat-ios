...
open class TCHChannels: NSObject {
    ...
    /**
     ...
     @return An array of all of the client's currently subscribed channels.
     */
    public func subscribedChannelsSorted(by criteria: TCHChannelSortingCriteria,
                                         order: TCHChannelSortingOrder) -> [TCHChannel] {
        // STUB
        return []
    }

    /**
     Retrieve a list of channel descriptors the user has a participation state on,
     for example invited, joined, creator.

     @param completion Completion block that will specify the result of the operation
     and a reference to the first page of user channel descriptors.
    ...
    /**
     ...
     @param completion Completion block that will specify the result of the operation
     and a reference to the first page of public channel descriptors.
     If no completion block is specified, no operation will be executed.
     */
    ...
    /**
     ...
     @param options Channel options for new channel whose keys are TCHChannelOption* constants.
     (optional - may be empty or nil)
     @param completion Completion block that will specify the result of the operation
     and a reference to the new channel.
     ...
     @discussion TCHChannelOptionType - Expected values are @(TCHChannelTypePublic)
     or @(TCHChannelTypePrivate) (optional)
     @discussion TCHChannelOptionAttributes - Expected value is an NSDictionary<NSString*,id> *,
     see also TCHChannel setAttributes:completion: (optional)
     */
    ...
    /**
     ...
     @param completion Completion block that will specify the result of the operation and
     a reference to the requested channel if it exists.
     */
